...
import BAutocomplete from './components/Autocomplete.vue';
import BTag from './components/Badge.vue';
import BCheckbox from './components/Checkbox.vue';
import BTable from './components/DataTable.vue';
import BDatepicker from './components/DateInput.vue';
import BField from './components/Field.vue';
...
import BSwitch from './components/Switch.vue';
import BTableColumn from './components/TableColumn.vue';
import BTaginput from './components/TagInput.vue';
import BUpload from './components/Upload.vue';
...
Vue.component('BDatetimepicker', BDatepicker);
