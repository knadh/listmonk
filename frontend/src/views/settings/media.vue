<template>
  <div class="items">
    <div class="row">
      <div class="col-2">
        <b-field :label="$t('settings.media.provider')">
      ...
      <div class="col-10">
        <b-field :label="$t('settings.media.upload.extensions')">
          <b-taginput v-model="data['upload.extensions']" name="tags" placeholder="jpg, png, gif .." />
        </b-field>
      </div>
    </div>
    <hr />
    ...
    <div v-if="data['upload.provider'] === 'filesystem'">
      <b-field :label="$t('settings.media.upload.path')" :message="$t('settings.media.upload.pathHelp')">
      ...
      <b-field :label="$t('settings.media.upload.uri')" :message="$t('settings.media.upload.uriHelp')">
    ...
    <div v-if="data['upload.provider'] === 's3'">
      ...
      <b-field :label="$t('settings.media.s3.secret')" message="Enter a value to change.">
      ...
      <b-field :label="$t('settings.media.s3.bucketType')">
      ...
      <b-field :label="$t('settings.media.s3.bucketPath')" :message="$t('settings.media.s3.bucketPathHelp')">
        <input aria-label="field" v-model="data['upload.s3.bucket_path']" name="upload.s3.bucket_path" :maxlength="200"
          placeholder="/">
      </b-field>

      <b-field :label="$t('settings.media.s3.uploadExpiry')" :message="$t('settings.media.s3.uploadExpiryHelp')">
      ...
      <b-field :label="$t('settings.media.s3.url')" :message="$t('settings.media.s3.urlHelp')">
      ...
      <b-field :label="$t('settings.media.s3.publicURL')" :message="$t('settings.media.s3.publicURLHelp')">
