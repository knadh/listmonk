    ...
    <div class="mb-6">
      ...
      <div class="card" v-if="data['bounce.webhooks_enabled']">
        ...
        <div class="row">
          <div class="col-3">
            <oat-field>
              <oat-switch v-model="data['bounce.azure'].enabled" name="azure_enabled" :native-value="true"
          ...
          <div class="col-4">
            <oat-field :label="$t('settings.bounces.azureSharedSecret')"
          ...
          <div class="col-5">
            <oat-field :label="$t('settings.bounces.azureSharedSecretHeader')"
