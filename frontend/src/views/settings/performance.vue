<template>
  <div class="items">
    <b-field :label="$t('settings.performance.concurrency')" :message="$t('settings.performance.concurrencyHelp')">
      <input aria-label="field" type="number" v-model.number="data['app.concurrency']" name="app.concurrency"
        placeholder="5" min="1" max="10000">
    </b-field>

    <b-field :label="$t('settings.performance.messageRate')" :message="$t('settings.performance.messageRateHelp')">
    ...
    <b-field :label="$t('settings.performance.batchSize')" :message="$t('settings.performance.batchSizeHelp')">
