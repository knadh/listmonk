<template>
  <div class="items">
    ...
    <oat-field :label="$t('settings.general.rootURL')" :message="$t('settings.general.rootURLHelp')">
    ...
    <oat-field :label="$t('settings.general.logoURL')" :message="$t('settings.general.logoURLHelp')">
    ...
    <oat-field :label="$t('settings.general.faviconURL')" :message="$t('settings.general.faviconURLHelp')">
    ...
    <hr />
    <oat-field :label="$t('settings.general.fromEmail')" :message="$t('settings.general.fromEmailHelp')">
    ...
    <oat-field :label="$t('settings.general.adminNotifEmails')" :message="$t('settings.general.adminNotifEmailsHelp')">
    ...
    <div>
      ...
      <oat-field :message="$t('settings.general.enablePublicArchiveRSSContentHelp')">
        <oat-switch v-model="data['app.enable_public_archive_rss_content']"
