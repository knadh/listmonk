<template>
  <section class="campaign">
    ...
    <b-tabs type="is-boxed" :animated="false" v-model="activeTab" @input="onTab">
      ...
      <b-tab-item :label="$t('campaigns.attribs')" icon="code" value="attribs" :disabled="isNew">
        <section class="wrap">
          <b-field :label="$t('campaigns.attribs')" :message="$t('campaigns.attribsHelp')" label-position="on-border">
...
export default Vue.extend({
  ...
  methods: {
    ...
    onSubmit(typ) {
      ...
      let attribs = null;
      if (this.form.attribsStr && this.form.attribsStr.trim() && this.form.attribsStr !== '{}') {
        try {
