{
    ...
    "[settings.media](http://settings.media).s3.uploadExpiryHelp": "(Opcional) Especifica TTL (en segons) per a l'URL presignada generada. Només aplicable a contenidors privats (s, m, h, d per a segons, minuts, hores, dies).",
