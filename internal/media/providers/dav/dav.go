...
type Opts struct {
	...
	Username string            `koanf:"dav_username"`
	Password string            `koanf:"dav_password"`
...
// NewDavStore will create new WebDAV Storage.
func NewDavStore(o Opts) (media.Store, error) {
	if o.RootPath == "" {
		o.RootPath = "/"
	}
