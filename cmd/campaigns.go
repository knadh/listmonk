...
// GetIndividualCampaignViewAnalytics retrieves view counts for a campaign.
func (a *App) GetIndividualCampaignViewAnalytics(c echo.Context) error {
	...
	// Get the analytics numbers from the DB for the campaigns.
	out, err := a.core.GetIndividualCampaignAnalyticsViews(id, from, to)
	if err != nil {
		return err
	}
